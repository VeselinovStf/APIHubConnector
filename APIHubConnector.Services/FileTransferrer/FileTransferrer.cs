...
using APIHUbConnector.Services.FileTransferrer.ExtensionMethods;
using System;
...
namespace APIHUbConnector.Services.FileTransferrer
{
    public class FileTransferrer : IFileTransferrer<ConvertedFileElementDTO>
    {
        ...
        public async Task<IList<ConvertedFileElementDTO>> FilesToList(string sourceDirName, bool copySubDirs = true)
        {
            ...
            var resultElement = new List<ConvertedFileElementDTO>(filePaths.Zip(fileContents, (fp, fc) => new ConvertedFileElementDTO()
            {
                FilePath = fp,
                FileContent = fc
            }));
